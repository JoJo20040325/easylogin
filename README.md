...
docker-compose up --build
```
4. 可以在[docker hub][18]上搜索**vue20040325/easylogin-backend**和**vue20040325/easylogin-frontend**分别下载后端和前端镜像，还有mysql的官方镜像，再通过docker-compose.images.yml 将前后端联系起来运行整个应用。
## 🤝 贡献
